...
const SKELETON_IDS = ['car-name', 'carType', 'carYear', 'carFuel', 'pricePerDay', 'main-img'];
...
function populatePage(car) {
  ...
  const specMap = {
    ...
    'bag':               car.trunk_litres ? `${car.trunk_litres} Bags` : '— Bags',
...
async function loadCarDetails() {
  ...
  if ('requestIdleCallback' in window) {
    requestIdleCallback(loadExtra, { timeout: 2000 });
  } else {
